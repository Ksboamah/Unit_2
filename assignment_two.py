...
print("WOW, really? The", user_dream_car, "is cool.")
...
possible_interest_rate = float(input("What annual interest rate do you think you will get on that?"))
monthly_interest_rate = (possible_interest_rate / 100) / 12
number_of_monthly_payments = (possible_loan_period * 12)

monthly_payment = (monthly_interest_rate * dream_car_cost) / (1 - (1 + monthly_interest_rate)
...
print("Your monthly payment for The", user_dream_car, "is", monthly_payment, "and the car total car cost is $",
      total_car_cost)
